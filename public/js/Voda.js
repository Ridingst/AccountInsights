...
$(document).ready(function() {
  ...
  $('.analysis-btn').click(function(){
    ...
    var inputEmail = document.getElementsByName('inputEmail')[0].value;
    var inputLocation = document.getElementsByName('inputLocation')[0].value;
    console.log("demo.js line 68 - " + inputName);
